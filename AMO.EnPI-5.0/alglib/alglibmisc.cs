    ...
    public class nearestneighbor
    {
        ...
        *************************************************************************/
            ...
            kdtree kdt)
        {
            ...
            alglib.ap.assert(apserv.apservisfinitematrix(xy, n, nx+ny), "KDTreeBuild: X contains infinite or NaN values");
            if( n>0 )
            {
                tags = new int[n];
                for(i=0; i<=n-1; i++)
        ...
        *************************************************************************/
            ...
            kdtree kdt)
        {
            ...
            alglib.ap.assert(apserv.apservisfinitematrix(xy, n, nx+ny), "KDTreeBuildTagged: X contains infinite or NaN values");
